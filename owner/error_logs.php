...
try {
    ...
    foreach ($errors as $err) {
        ...
        $device = $err['device_info'] ?: 'Unknown';
...
.tb-database{background:var(--blue-light);color:#075985}.tb-auth{background:#FFF7ED;color:#9A3412}.tb-other{background:#F3F4F6;color:var(--text-secondary)}
